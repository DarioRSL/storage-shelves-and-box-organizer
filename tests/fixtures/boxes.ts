...
export const ELECTRONICS_BOX: BoxFixture = {
  name: 'Electronics',
  description: 'Old cables, chargers, and adapters. Includes USB-C cables, Lightning cables, HDMI cables, and power adapters.',
