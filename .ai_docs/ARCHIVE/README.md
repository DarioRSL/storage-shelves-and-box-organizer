...
This directory contains historical project documentation from the MVP development phase (December 2025 - January 2026).
...
For active project planning, see:
- `.ai_docs/ROADMAP.md` - Unified roadmap (single source of truth)
- `.ai_docs/prd.md` - Product Requirements Document
- `.ai_docs/api-plan.md` - API Specification
- `.ai_docs/db-plan.md` - Database Schema
- `.ai_docs/CONTRIBUTING.md` - Contribution Guidelines
